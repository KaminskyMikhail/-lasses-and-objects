...
public:
	Calculator() {
		do {
			std::cout << "Enter num1: ";
			while (!(std::cin >> __num1)) {
				std::cin.clear();
				std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
				std::cout << "Uncorrect input!" << std::endl << "Enter num1: ";
			}
			if (__num1 == 0) std::cout << "Uncorrect input!\n";
		} while (__num1 == 0);
		do {
			std::cout << "Enter num2: ";
			while (!(std::cin >> __num2)) {
				std::cin.clear();
				std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
				std::cout << "Uncorrect input!" << std::endl << "Enter num2: ";
			}
				if (__num2 == 0) std::cout << "Uncorrect input!\n";
		} while (__num2 == 0);
	}
